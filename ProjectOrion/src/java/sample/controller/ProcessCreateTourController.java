 ...
 * @author Orion
 */
public class ProcessCreateTourController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<TourCategoryDTO> result = dao.getAllCategoryName();
            request.setAttribute("CATEGORY", result);
        } catch (Exception e) {
            log("ERROR at ProcessCreateTourController " + e.getMessage());
        } finally {
